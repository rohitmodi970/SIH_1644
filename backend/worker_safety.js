...
app.post('/monitor', (req, res) => {
  ...
  if (co_ppm > 100) {
    alerts.push({
      safety_message: "CRITICAL FIRE ALERT:<br>1. CO levels are dangerously high.<br>2. Immediate action is required.<br>Use of Fire Suppression Systems is recommended in critical areas.<br>",
    ...
    alerts.push({
      safety_message: "CRITICAL HEALTH WARNING FOR CO LEVELS:<br>1. CO levels are elevated.<br>2. No human should enter the area due to the fatal risk.<br>",
    ...
    alerts.push({
      safety_message: "ALERT FOR CO:<br>1. CO levels are elevated, causing risk of headaches, dizziness, and nausea.<br>2. Immediate ventilation is required.<br>",
  ...
  if (ch4_lel > 12) {
    alerts.push({
      safety_message: "CRITICAL EXPLOSION ALERT FOR METHANE:<br>1. Methane levels are dangerously high. <br>2. Immediate evacuation is required.<br>",
  ...
  if (alerts.length === 0) {
    alerts.push({
      safety_message: "<br>1.All safety parameters are within normal limits. <br>2. No risk of fire or respiratory problems for workers.<br>2. Operations can continue as usual.<br>",
